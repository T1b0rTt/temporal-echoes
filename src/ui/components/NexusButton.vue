...
const canAscend = computed(() => game.canNexusAscend());
const rewardDisplay = computed(() => num.format(game.getNexusAscendReward(), 0));
const ascensionsCount = computed(() => game.nexusAscensions);
